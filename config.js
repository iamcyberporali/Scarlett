...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*Made by Scarlett*' : process.env.ALL_CAPTION,
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://telegra.ph/file/e4ae60759b92c95c1e827.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    AFNN: process.env.TAG_REPLY === undefined ? '919778062036@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '919778062036' : process.env.ALL_NUMBER,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? '♚◢𝑪𝒀𝑩𝑬𝑹 ☠︎︎ 𝑷𝑶𝑹𝑨𝑳𝑰◣♚' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '⍟▰↢𝑺𝑪𝑨𝑹𝑳𝑬𝑻𝑻↣▬⍟' : process.env.BOT_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/thorloki_official' : process.env.IG,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/e4ae60759b92c95c1e827.jpg' : process.env.ALL_IMG,
    ...
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'false' : process.env.AUTO_FAKE,
    ...
    SKV: process.env.V_HEADER === undefined ? '*⍟▰↢𝑺𝑪𝑨𝑹𝑳𝑬𝑻𝑻↣▬⍟*' : process.env.V_HEADER,
    SKDR: process.env.DURATION === undefined ? '9876543210' : process.env.DURATION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '919778062036' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUDO: process.env.SUDO === undefined ? '919778062036,0' : process.env.SUDO,
    DEBUG: DEBUG,
